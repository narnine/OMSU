...
typedef struct List List; // не специфицированная структура, конкретные
                          // реализации должны быть описаны в c-файлах
...
void AppendAll(List *, const List *);
// void AppendAll(List *,
//               List *); // вставить все элементы одного списка в конец другого
...
int Pop(List *); // удаление элемента с конца списка, функция возвращает
                 // удаленный элемент
int Dequeue(List *); // удаление элемента с начала списка, функция возвращает
                     // удаленный элемент
